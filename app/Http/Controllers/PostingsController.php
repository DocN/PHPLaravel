...
class PostingsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        //return view('postings.posting')->with('postingID', $id);
        //return "how one job posting here : number " .$id;
    }
    ...
    {
        //
        return "save the newly edited job postings here";
    }
    ...
    {
        //
        return " delete (or mark as deleted) job postigns here";
    }
}
